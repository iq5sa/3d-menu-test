...
suite('Controls', () => {
    ...
    suite('camera-controls', () => {
        ...
        suite('when user is interacting', () => {
            ...
            test.skip('does not send "user-interaction" after JS change', async () => {
                ...
                element.addEventListener('camera-change', (event) => {
                    changeSource.push(event.detail.source);
                });
        ...
        suite('synthetic interaction', () => {
            ...
            test.skip('return one finger to starting point returns camera to starting point', async () => {
                const orbit = element.getCameraOrbit();
                element.interactionPrompt = 'none';
